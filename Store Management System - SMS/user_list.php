			...
			<div class="row">
				...
				<div class="col-md-8 p-3 border-start border-success">
					<?php 
						...
						echo "<table class='table table-striped table-hover'><tr><th>User ID</th><th>User First Name</th><th>User Last Name</th><th>User Email</th><th>Action</th></tr>";
						...
						while($data = mysqli_fetch_assoc($query)) {
							...
							echo "<tr class='align-middle'>
									...
									<td>$userLastname</td>
									<td>$userEmail</td>
									<td><a class='btn btn-success' href='edit_user.php?id=$userID'>Edit</a></td>
								</tr>";
						}
