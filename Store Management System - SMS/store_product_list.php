			...
			<div class="row">
				...
				<div class="col-md-8 p-3 border-start border-success">
					<?php 
						...
						echo "<table  class='table table-striped table-hover'><tr><th>Store Product ID</th><th>Store Product Name</th><th>Store Product Quantity</th><th>Store Product Entry Date</th><th>Action</th></tr>";
						...
						while($data = mysqli_fetch_assoc($query)) {
							...
							echo "<tr class='align-middle'>
									...
									<td>$stPdQuantity</td>
									<td>$pdEnDate</td>
									<td><a class='btn btn-success' href='edit_store_product.php?id=$stPdID'>Edit</a></td>
								</tr>";
						}
